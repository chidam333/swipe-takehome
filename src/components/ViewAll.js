...
import {AiFillCopy,AiFillEye} from 'react-icons/ai'
...
export default function ViewAll(){
    ...
    useEffect(()=>{
        ...
        for(let i in states){
            ...
            arr.push(
                <li class="list-group-item container-fluid position-relative border-2 border-dark" key={states[i].invoiceNumber}>
                    ...
                    <div class="d-flex position-absolute " style={{top:'10%',right:'10%'}}>
                        <button class="btn btn-outline-danger py-1 mx-2" onClick={(e)=>{dispatch(del(states[i].invoiceNumber))}}>X</button>
                        <button class="btn btn-primary py-1 mx-2" onClick={(e)=>{copyCur(states[i])}}><AiFillCopy/></button>
